...
void main() {
  ...
  testWidgets('CA-006-08: tocar el asa abre "Mover" y elegir mueve la tarea', (
    tester,
  ) async {
  ...
  testWidgets(
    'CA-006-08: con el teclado, Tab llega al asa e Intro abre "Mover"',
    (tester) async {
  ...
  testWidgets('CA-006-16: "Hacer actual" desde el lector mueve al instante', (
    tester,
  ) async {
    final handle = tester.ensureSemantics();
    final repo = await openList(
    ...
    expect(
      find.bySemanticsLabel('1 de 3. Tarea actual: Tercera'),
      findsOneWidget,
    );
    handle.dispose();
  });
