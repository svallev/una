...
| DEV-06 | Botón: "Pulsa para completar" | "Mantén pulsado para completar"; al pulsar: "Sigue pulsando…"; al terminar: "¡Hecho!" (los textos `holdHint` del propio prototipo) | "Pulsa" induce a un toque simple que no hace nada | Decisión propia |
