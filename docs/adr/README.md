...
| ADR | Título | Estado |
|---|---|---|
| [0001](0001-stack-tecnologico.md) | Flutter como stack de la app | Provisional (spikes S1–S6) |
...
| [0004](0004-copias-de-seguridad.md) | Incluir los datos en las copias de seguridad del sistema | Aceptado |
...
| [0007](0007-url-sin-conexion.md) | URL: WebView endurecida + captura de página completa | Provisional (S4) |
| [0008](0008-visor-de-documentos.md) | PDF dentro; el resto, con el visor del sistema | Provisional (S3) |
| [0009](0009-monorepo-y-landing.md) | Monorepo: `app/` y `landing/` | Aceptado |
| [0010](0010-vercel-web-de-pruebas.md) | Web de pruebas en Vercel | Provisional (S6) |
