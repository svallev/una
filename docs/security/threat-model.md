...
| T-7 | Copias de seguridad | Divulgación vía iCloud/Google | Incluidas por decisión (ADR-0004); explicado en "Acerca de"; los temporales y cachés se excluyen. **Residual (spec 004):** una copia anterior a una eliminación conserva la tarea y, al restaurarla, vuelve como pendiente | STORAGE-2 |
